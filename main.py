...
data_path = 'D:/bodi/my_projects/practical_project/data-set'
...
new_target = to_categorical(target, len(categories))  # Using to_categorical from tensorflow.keras.utils
